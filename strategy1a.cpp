#ifndef STRATEGY1A_CPP
#define STRATEGY1A_CPP
            ...
            loop(d_code)
            {
                ...
                if (accessible)
                {
                    if (b.go_able(s_chess, d_pos) && (!eat_shit))
                    {
                        ...
                        float value1 = calculate_value(b2, belong_to),
                              value2 = calculate_position_value(b2, belong_to),
                              value3 = calculate_value(b2, ally_country(belong_to)),
                              value4 = calculate_value(b2, right_country(belong_to)),
                              value5 = calculate_value(b2, left_country(belong_to)),
                              value6 = calculate_position_value(b2, right_country(belong_to)),
                              value7 = calculate_position_value(b2, left_country(belong_to))
                                ;
                        ...
                        if (b.debug2)
                        {
                            ...
                            put_string += " = " + QString("%1").arg(value1) + " + "
                                                + QString("%1").arg(value2) + " + "
                                                + QString("%1").arg(value3) + " - "
                                                + QString("%1").arg(value4) + " - "
                                                + QString("%1").arg(value5) + " - "
                                                + QString("%1").arg(value6) + " - "
                                                + QString("%1").arg(value7)
                                    ;
